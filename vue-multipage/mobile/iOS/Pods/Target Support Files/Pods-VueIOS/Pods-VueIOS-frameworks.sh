...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SPGDatePicker/SPGDatePicker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SYeeBadgeView/SYeeBadgeView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SZJPickerView/SZJPickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YBAttributeTextTapAction/YBAttributeTextTapAction.framework"
