//
//  CustomPGDatePickManagerHeaderView.m
//  Demo
//
...
@interface CustomPGDatePickManagerHeaderView ()
...
@implementation CustomPGDatePickManagerHeaderView
...
- (void)cancelButtonHandler {
    if (self.cancelButtonHandlerBlock) {
        self.cancelButtonHandlerBlock(_cancelButton);
    }
}

- (void)confirmButtonHandler {
    if (self.confirmButtonHandlerBlock) {
        self.confirmButtonHandlerBlock(_confirmButton);
    }
}
...
- (void)setLanguage:(NSString *)language {
    ...
    NSString *confirmButtonText = nil;
    if (_confirmButton.tag == 0) {
        confirmButtonText = [NSBundle pg_localizedStringForKey:@"nextButtonText" language:self.language];
    }
    else {
        confirmButtonText = [NSBundle pg_localizedStringForKey:@"confirmButtonText" language:self.language];
    }
